...
PUB_TOPIC_NAME_2 = 'lidar_crop'  # 물체 감지 여부를 퍼블리시할 토픽 이름
...
class ObjectDetection(Node):
    def __init__(self):
        ...
        #self.publisher2 = self.create_publisher(LaserScan,PUB_TOPIC_NAME_2, self.qos_profile)
    ...
    def lidar_callback(self, msg):
        ...
        start_angle = 180  # 원하는 각도 범위의 시작 값
        end_angle = 270 # 원하는 각도 범위의 끝 값
        
        range_min = 0.5 # 원하는 거리 범위의 최소값 [m]
        range_max = 1.4# 원하는 거리 범위의 최대값 [m]
